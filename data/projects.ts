...
export const projects: Project[] = [
  {
    ...
    role: ["产品设计", "AI 能力设计", "全栈架构"], cover: "", accent: "care",
  ...
  },
  {
    ...
    role: ["产品架构", "全栈开发", "AI/RAG", "GIS/三维"], cover: "", accent: "water",
  ...
  },
  {
    ...
    role: ["产品设计", "平台架构", "Agent 编排"], cover: "", accent: "silicon",
  ...
  },
  {
    ...
    role: ["iOS 开发", "交互设计", "视觉算法"], cover: "", accent: "motion",
  ...
  },
  {
    ...
    role: ["产品战略", "系统架构", "全栈开发"], cover: "", accent: "platform",
